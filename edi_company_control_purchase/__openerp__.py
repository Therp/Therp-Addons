...
{
    "name": "EDI Company Control - Purchase Orders",
    "description": """
...
This module implements company level control of this feature for
purchase orders, adding a setting 'Enable EDI Purchase Order Emails'.
...
""",
    ...
    "depends": ['purchase', 'edi_company_control_invoice'],
    "update_xml": [
